...
class PriorityQueue {
  ...
  sinkDown() {
    ...
    while (true) {
      ...
      let largestChildPriorityVal = Math.max(
        leftChildNode.priority,
        rightChildNode.priority
      );
      if (
        largestChildPriorityVal === leftChildNode.priority &&
        ...
        largestChildPriorityVal === rightChildNode.priority &&
...
hospitalQueue.enqueue('cold', 1);
hospitalQueue.enqueue('Gun Shot wound', 5);
hospitalQueue.enqueue('fever', 2);
hospitalQueue.enqueue('broken Arm', 4);
hospitalQueue.enqueue('Loose Motion', 3);
hospitalQueue.enqueue('Head Off', 6);
